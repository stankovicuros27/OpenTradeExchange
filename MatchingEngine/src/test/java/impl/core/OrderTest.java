...
public class OrderTest {
    ...
    public void testMatchBuySidePlaceOrderRequest() {
        ...
        PlaceOrderRequest buyOrderRequest = new PlaceOrderRequest(1, 0, 11, 1001, Side.BUY, 10, 0);
        ...
        buyOrderRequest = new PlaceOrderRequest(1, 0, 11, 1001, Side.BUY, 10, 0);
        ...
        buyOrderRequest = new PlaceOrderRequest(1, 0, 21, 1001, Side.BUY, 100, 0);
        trade = Order.matchOrderRequest(sellOrder, buyOrderRequest, mockTimestampProvider);
    ...
    public void testMatchSellSidePlaceOrderRequest() {
        ...
        PlaceOrderRequest sellOrderRequest = new PlaceOrderRequest(1, 0, 10, 1001, Side.SELL, 10, 0);
        ...
        sellOrderRequest = new PlaceOrderRequest(1, 0, 10, 1001, Side.SELL, 10, 0);
        ...
        sellOrderRequest = new PlaceOrderRequest(1, 0, 20, 1001, Side.SELL, 100, 0);
        trade = Order.matchOrderRequest(buyOrder, sellOrderRequest, mockTimestampProvider);
