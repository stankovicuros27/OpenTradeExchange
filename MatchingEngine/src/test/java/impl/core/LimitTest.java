...
public class LimitTest {
    ...
    public void testAddOrder() {
        ...
        assertEquals(response, new OrderStatusResponse(firstOrder.getUserID(), firstOrder.getOrderID(), OrderResponseStatus.PLACED_ORDER));
        ...
        assertEquals(response, new OrderStatusResponse(secondOrder.getUserID(), secondOrder.getOrderID(), OrderResponseStatus.PLACED_ORDER));
        ...
        assertEquals(response, new OrderStatusResponse(thirdOrder.getUserID(), thirdOrder.getOrderID(), OrderResponseStatus.PLACED_ORDER));
    ...
    public void testCancelOrder() {
        ...
        assertEquals(response, new OrderStatusResponse(firstOrder.getUserID(), firstOrder.getOrderID(), OrderResponseStatus.CANCELLED_ORDER));
        ...
        assertEquals(response, new OrderStatusResponse(thirdOrder.getUserID(), thirdOrder.getOrderID(), OrderResponseStatus.CANCELLED_ORDER));
        verify(mockOrderLookupCache).removeOrder(thirdOrder);
        assertEquals(limit.getVolume(), 10);
        assertEquals(limit.getNumberOfOrders(), 1);

        response = limit.cancelOrder(secondOrder);
        assertEquals(response, new OrderStatusResponse(secondOrder.getUserID(), secondOrder.getOrderID(), OrderResponseStatus.CANCELLED_ORDER));
    ...
    public void testMatchCounterOrder() {
        ...
        PlaceOrderRequest firstSellOrderRequest = new PlaceOrderRequest(1, 0, 9, 1000, Side.SELL, 5, 0);
        ...
        assertThat(responses).hasSize(2).hasSameElementsAs(List.of(
                ...
                new OrderStatusResponse(1, 0, OrderResponseStatus.CLOSED_ORDER)
        ));
        assertEquals(limit.getVolume(), 25);
        assertEquals(limit.getNumberOfOrders(), 2);

        PlaceOrderRequest secondSellOrderRequest = new PlaceOrderRequest(1, 1, 8, 1000, Side.SELL, 25, 0);
        ...
        assertThat(responses).hasSize(5).hasSameElementsAs(List.of(
                ...
                new OrderStatusResponse(0, 0, OrderResponseStatus.CLOSED_ORDER),
                new OrderStatusResponse(0, 1, OrderResponseStatus.CLOSED_ORDER),
                new OrderStatusResponse(1, 1, OrderResponseStatus.CLOSED_ORDER)
        ));
        assertTrue(limit.isEmpty());
        ...
        PlaceOrderRequest thirdSellOrderRequest = new PlaceOrderRequest(1, 2, 7, 1000, Side.SELL, 50, 0);
        responses = limit.matchOrderRequest(thirdSellOrderRequest);
        assertThat(responses).hasSize(2).hasSameElementsAs(List.of(
                new TradeResponse(0, 2, 1, 2, 10, 50, DUMMY_TIMESTAMP_SECONDS),
                new OrderStatusResponse(1, 2, OrderResponseStatus.CLOSED_ORDER)
        ));
